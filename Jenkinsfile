...
def sshEnv() {
  return ["TARGET_ARCH=${env.TARGET_ARCH}", "ELECTRON_S3_BUCKET=${env.ELECTRON_S3_BUCKET}",
    "LIBCHROMIUMCONTENT_MIRROR=${env.LIBCHROMIUMCONTENT_MIRROR}", "CI=${env.CI}",
    "ELECTRON_RELEASE=${env.ELECTRON_RELEASE}", "GYP_DEFINES=${env.GYP_DEFINES}",
    "ELECTRON_S3_SECRET_KEY=${env.ELECTRON_S3_SECRET_KEY}",
    "ELECTRON_S3_ACCESS_KEY=${env.ELECTRON_S3_ACCESS_KEY}",
    "ELECTRON_GITHUB_TOKEN=${env.ELECTRON_GITHUB_TOKEN}"].join(' ')
}
